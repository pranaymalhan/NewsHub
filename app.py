...
def search():
    ...
    articles = sorted(results,key = lambda x:x[1].published_parsed, reverse=True)
    ...
    return render_template('search_results.html',articles = paginated_articles,page=page,total_pages = total_articles//per_page + 1, query = query)
